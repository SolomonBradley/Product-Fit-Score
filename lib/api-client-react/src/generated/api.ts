...
export const analyzeProduct = async (analyzeProductBody: AnalyzeProductBody, options?: RequestInit): Promise<FitScoreResult> => {
...
export const getAnalyzeProductMutationOptions = <TError = ErrorType<ErrorResponse>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof analyzeProduct>>, TError,{data: BodyType<AnalyzeProductBody>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof analyzeProduct>>, TError,{data: BodyType<AnalyzeProductBody>}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof analyzeProduct>>, {data: BodyType<AnalyzeProductBody>}> = (props) => {
          const {data} = props ?? {};
 ...
 * @summary Analyze a product URL and generate a personalized Fit Score
 */
export const useAnalyzeProduct = <TError = ErrorType<ErrorResponse>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof analyzeProduct>>, TError,{data: BodyType<AnalyzeProductBody>}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
...
export const boostScore = async (boostScoreBody: BoostScoreBody, options?: RequestInit): Promise<FitScoreResult> => {
...
export const getBoostScoreMutationOptions = <TError = ErrorType<ErrorResponse>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof boostScore>>, TError,{data: BodyType<BoostScoreBody>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof boostScore>>, TError,{data: BodyType<BoostScoreBody>}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof boostScore>>, {data: BodyType<BoostScoreBody>}> = (props) => {
          const {data} = props ?? {};
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type BoostScoreMutationResult = NonNullable<Awaited<ReturnType<typeof boostScore>>>
 ...
 * @summary Recalculate fit score with boosted feature weight
 */
export const useBoostScore = <TError = ErrorType<ErrorResponse>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof boostScore>>, TError,{data: BodyType<BoostScoreBody>}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
...
export const getGetHistoryQueryOptions = <TData = Awaited<ReturnType<typeof getHistory>>, TError = ErrorType<ErrorResponse>>( options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getHistory>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
) => {
...
export const getGetHistoryStatsQueryOptions = <TData = Awaited<ReturnType<typeof getHistoryStats>>, TError = ErrorType<ErrorResponse>>( options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getHistoryStats>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
) => {
...
export function useGetHistoryStats<TData = Awaited<ReturnType<typeof getHistoryStats>>, TError = ErrorType<ErrorResponse>>(
